...
datos <- gs %>%
  range_read("total") %>%
  mutate(
    Forma_arbol_descripcion = recode(Forma_arbol,
      `3` = "Single-stemmed trees",
      `2` = "Intermediate trees",
      `1` = "Multi-stemmed trees"
    ),
    Calidad_tronco_descripcion = recode(Calidad_tronco,
      `3` = "High-quality tree, free of defects or with minimal defects",
      `2` = "Moderate-quality tree with defects",
      `1` = "Poor-quality tree with significant defects"
    ),
    Produccion_frutos_descripcion = recode(Produccion_frutos,
      `4` = "Trees bearing fruit on 100% of branches",
      `3` = "Trees bearing fruit on up to 75% of branches",
      `2` = "Trees bearing fruit on up to 50% of branches",
      `1` = "Trees bearing fruit on up to 25% of branches",
      `0` = "Trees without fruit"
    ),
    Calidad_frutos_descripcion = recode(Calidad_frutos,
      `3` = "Trees with very sweet fruit",
      `2` = "Trees with sweet fruit",
      `1` = "Trees with very bitter fruit",
      `0` = "Trees with bitter fruit"
    ),
    Calidad_follaje_descripcion = recode(Calidad_follaje,
      `3` = "Trees with foliage on all branches",
      `2` = "Trees with foliage on up to two-thirds of branches",
      `1` = "Trees with foliage on up to one-third of branches"
    ),
    Bifurcacion_descripcion = recode(Bifurcacion,
      `3` = "No evidence of bifurcation",
      `2` = "Forked at breast height (DBH)",
      `1` = "Presence of bifurcation below breast height (DBH)"
    )
  ) %>%
  select(
...
fila1 <- plot_grid(f1a, f1b, ncol = 2, labels = "auto", rel_widths = c(1, 1.4))
